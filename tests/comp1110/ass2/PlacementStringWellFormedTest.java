...
public class PlacementStringWellFormedTest {
    ...
    public void n4Pieces() {
        ...
        // Test case more than 10 pieces - u6923736
        test(SOLUTIONS[20].placement + "a123", false);
        test(SOLUTIONS[110].placement.substring(0, 15), false);
    }
    ...
    @Test
    public void duplicatesC() {
        for (int i = 0; i < 40; i += 4) {
            if (i == 12)
                continue;
            String bad = SOLUTIONS[50].placement.substring(0, i) +
                    SOLUTIONS[50].placement.substring(12, 16) +
                    SOLUTIONS[50].placement.substring(16, 20)+
                    SOLUTIONS[50].placement.substring(i + 4, 40);
